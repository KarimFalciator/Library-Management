...
class reset_password_UI:
    ...
    def __init__(self, reset):
        ...
        # Set appearance and theme for the entire UI
    ...
    def create_teacher_tab(self):
        ...
        self.submit_button = ctk.CTkButton(teacher_tab, text='Send Email', width=10, command=self.submit_t_email)
    ...
    def submit_t_email(self):
        ...
        if teacher:
            ...
            error_label = ctk.CTkLabel(self.reset, text='Invalid ID or email', text_color='#FF0400', font=('Arial', 13))
    ...
    def reset_pass_window(self):
        ...
        self.pass_label = ctk.CTkLabel(self.reset_window, text="Enter New Password:")
        self.pass_label.pack(padx=10, pady=10)
        self.pass_entry = ctk.CTkEntry(self.reset_window, show='•')
        ...
        self.passconfirm_entry = ctk.CTkEntry(self.reset_window, show='•')
